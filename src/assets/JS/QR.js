...
document.getElementById('pauseBtn').addEventListener('click', pauseCamera);
    ...
    scanTimeout = setTimeout(() => {
        ...
        if (canvas.width > 0 && canvas.height > 0) {
            ...
            try {
                ...
                console.error("Lỗi khi quét mã QR:", e);
            }
        }
...
function updateTicketInfo(isValid, ticketData) {
    ...
    if (isValid) {
        ...
        // Cập nhật thông tin vé
        ticketInfo.querySelector('.detail-value:nth-of-type(1)').textContent = ticketData.movieName;
        ticketInfo.querySelector('.detail-value:nth-of-type(2)').textContent = ticketData.cinema;
        ticketInfo.querySelector('.detail-value:nth-of-type(3)').textContent = ticketData.date;
        ticketInfo.querySelector('.detail-value:nth-of-type(4)').textContent = ticketData.time;
        ticketInfo.querySelector('.detail-value:nth-of-type(5)').textContent = ticketData.seats;
        ticketInfo.querySelector('.detail-value:nth-of-type(6)').textContent = ticketData.code;
        ...
        ticketInfo.querySelector('.detail-value:nth-of-type(1)').textContent = 'N/A';
        ticketInfo.querySelector('.detail-value:nth-of-type(2)').textContent = 'N/A';
        ticketInfo.querySelector('.detail-value:nth-of-type(3)').textContent = 'N/A';
        ticketInfo.querySelector('.detail-value:nth-of-type(4)').textContent = 'N/A';
        ticketInfo.querySelector('.detail-value:nth-of-type(5)').textContent = 'N/A';
        ticketInfo.querySelector('.detail-value:nth-of-type(6)').textContent = ticketData.code || 'N/A';

        // Thay đổi poster phim
        ticketInfo.querySelector('.movie-poster').src = 'https://via.placeholder.com/400x200/1a1f2c/e50914?text=Invalid+Ticket';
    }
...
function addToHistory(code, isValid) {
    ...
    li.innerHTML = `
                <span>Vé #${code.substr(0, 10)} - ${isValid ? 'Hợp lệ' : 'Không hợp lệ'}</span>
...
function generateRandomTicketData() {
    const movies = [
        { name: "Avengers: Endgame", poster: "https://via.placeholder.com/400x200/1a1f2c/e50914?text=Avengers:+Endgame" },
        { name: "Dune: Part Two", poster: "https://via.placeholder.com/400x200/1a1f2c/e50914?text=Dune:+Part+Two" },
        { name: "Oppenheimer", poster: "https://via.placeholder.com/400x200/1a1f2c/e50914?text=Oppenheimer" },
        { name: "The Batman", poster: "https://via.placeholder.com/400x200/1a1f2c/e50914?text=The+Batman" },
        { name: "Inside Out 2", poster: "https://via.placeholder.com/400x200/1a1f2c/e50914?text=Inside+Out+2" }
    ];
...
document.getElementById('ticketInfo').classList.add('active');
